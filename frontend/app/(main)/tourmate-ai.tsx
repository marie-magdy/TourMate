...
const styles = StyleSheet.create({
  ...
  voiceAvatarLarge:      { width: 110, height: 110, borderRadius: 55, backgroundColor: '#2A2A2A', justifyContent: 'center', alignItems: 'center', marginBottom: 28, borderWidth: 2, borderColor: '#E67E22' },
  voiceAvatarSpeaking:   { borderColor: '#27AE60' },
  voiceAvatarThinking:   { borderColor: '#3498DB' },
  voiceAvatarEmoji:      { fontSize: 48 },
